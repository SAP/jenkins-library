...
Besides that, we have an integration test suite, which is not triggered during normal pull request builds. Integration tests are mandatory before a change can be merged. It is the duty of a team member of the SAP/jenkins-library project to execute these tests.
