...
Build an application based on SAPUI5 or SAP Fiori with Jenkins and deploy the build result into an SAP BTP account in the Cloud Foundry environment. Optionally, deploy the build result into the Neo environment.
