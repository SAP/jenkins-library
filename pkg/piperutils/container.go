...
// ContainerRegistryFromURL provides the registry part of a complete registry url including the protocol
...
func ContainerRegistryFromImage(fullImage string) (string, error) {
	ref, err := name.ParseReference(strings.ToLower(fullImage))
	if err != nil {
