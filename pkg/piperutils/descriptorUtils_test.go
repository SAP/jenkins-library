...
func TestDetermineProjectCoordinates(t *testing.T) {
	...
	t.Run("maven major-minor", func(t *testing.T) {
		...
		assert.Equal(t, "com.test.pkg-analyzer", name, "Expected different result")
		assert.Equal(t, "1.2", version, "Expected different result")
	})
	...
	t.Run("maven full", func(t *testing.T) {
		...
		assert.Equal(t, "com.test.pkg-analyzer", name, "Expected different result")
		assert.Equal(t, "1.2.3-7864387648746", version, "Expected different result")
	})
	...
	t.Run("maven semantic", func(t *testing.T) {
		...
		assert.Equal(t, "com.test.pkg-analyzer", name, "Expected different result")
		assert.Equal(t, "1.2.3", version, "Expected different result")
	})
	...
	t.Run("maven original", func(t *testing.T) {
		...
		assert.Equal(t, "com.test.pkg-analyzer", name, "Expected different result")
		assert.Equal(t, "0-SNAPSHOT", version, "Expected different result")
	})
	...
	t.Run("python version text", func(t *testing.T) {
		...
		assert.Equal(t, "python-test", name, "Expected different result")
		assert.Equal(t, "1234", version, "Expected different result")
	})
}
