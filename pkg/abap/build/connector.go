...
type Connector struct {
	...
	Baseurl                string
	MaxRuntimeInMinutes    time.Duration // just as handover parameter for polling functions
	PollIntervalsInSeconds time.Duration // just as handover parameter for polling functions
}
