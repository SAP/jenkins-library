...
type Config struct {
	...
	General                  map[string]any            `json:"general" yaml:"general"`
	Stages                   map[string]map[string]any `json:"stages" yaml:"stages"`
	Steps                    map[string]map[string]any `json:"steps" yaml:"steps"`
