...
func TestGetContextParameterFilters(t *testing.T) {
	...
	t.Run("Secrets", func(t *testing.T) {
		...
		assert.Equal(t, []string{"testSecret1", "testSecret2"}, filters.Env, "incorrect filter SetEnv")
	})
	...
	t.Run("Containers", func(t *testing.T) {
		...
		assert.NotEqual(t, []string{"containerCommand", "containerShell", "dockerEnvVars", "dockerImage", "dockerOptions", "dockerPullImage", "dockerVolumeBind", "dockerWorkspace", "pip", "scanType"}, filters.Env, "incorrect filter SetEnv")
	})
	...
	t.Run("Sidecars", func(t *testing.T) {
		...
		assert.NotEqual(t, []string{"containerName", "containerPortMappings", "dockerName", "sidecarEnvVars", "sidecarImage", "sidecarName", "sidecarOptions", "sidecarPullImage", "sidecarReadyCommand", "sidecarVolumeBind", "sidecarWorkspace"}, filters.Env, "incorrect filter SetEnv")
	})
}
