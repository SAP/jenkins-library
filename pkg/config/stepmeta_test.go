...
func TestGetParameterFilters(t *testing.T) {
	...
	testTable := []struct {
		...
		{
			Metadata:              metadata1,
			ExpectedGeneral:       []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramSeven", "mta"},
			ExpectedSteps:         []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramSeven", "mta"},
			ExpectedStages:        []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramThree", "paramSeven", "mta"},
			ExpectedParameters:    []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramThree", "paramFour", "paramSeven", "mta"},
			ExpectedEnv:           []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramThree", "paramFour", "paramFive", "paramSeven", "mta"},
			ExpectedAll:           []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramThree", "paramFour", "paramFive", "paramSix", "paramSeven", "mta"},
			...
			NotExpectedEnv:        []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramSix", "mta"},
			NotExpectedAll:        []string{},
		},
		{
			Metadata:              metadata2,
			ExpectedGeneral:       []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne"},
			ExpectedSteps:         []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramTwo"},
			ExpectedStages:        []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramThree"},
			ExpectedParameters:    []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramFour"},
			ExpectedEnv:           []string{"paramFive"},
			ExpectedAll:           []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramThree", "paramFour", "paramFive", "paramSix"},
			NotExpectedGeneral:    []string{"paramTwo", "paramThree", "paramFour", "paramFive", "paramSix"},
			...
			NotExpectedEnv:        []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId", "paramOne", "paramTwo", "paramThree", "paramFour", "paramSix"},
			NotExpectedAll:        []string{},
		},
		{
			Metadata:           metadata3,
			ExpectedGeneral:    []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId"},
			ExpectedStages:     []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId"},
			ExpectedSteps:      []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId"},
			ExpectedParameters: []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId"},
			ExpectedEnv:        []string{},
			ExpectedAll:        []string{"verbose", "uploadReportsToGCS", "gcpJsonKeyFilePath", "gcsTargetFolder", "gcsBucketId"},
		},
	}
