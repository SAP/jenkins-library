...
func TestGetStepConditionDetails(t *testing.T) {
	tt := []struct {
		...
		{name: "noCondition", step: config.Step{Conditions: []config.StepCondition{}}, expected: ""},
		...
		{name: "inactive", step: config.Step{Conditions: []config.StepCondition{{Inactive: true}}}, expected: "<i>inactive by default</i> - activate explicitly"},
