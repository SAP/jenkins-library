...
// APIResultListIssueAuditComment Api result list issue audit comment
// swagger:model ApiResult«List«Issue Audit Comment»»
...
func (m *APIResultListIssueAuditComment) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueAuditComment) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueAuditComment
