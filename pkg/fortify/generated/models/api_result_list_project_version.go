...
// APIResultListProjectVersion Api result list project version
// swagger:model ApiResult«List«Project Version»»
...
func (m *APIResultListProjectVersion) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListProjectVersion) UnmarshalBinary(b []byte) error {
	var res APIResultListProjectVersion
