...
// APIResultListArtifact Api result list artifact
// swagger:model ApiResult«List«Artifact»»
...
func (m *APIResultListArtifact) validateData(formats strfmt.Registry) error {
