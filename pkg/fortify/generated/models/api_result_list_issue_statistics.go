...
// APIResultListIssueStatistics Api result list issue statistics
// swagger:model ApiResult«List«Issue Statistics»»
...
func (m *APIResultListIssueStatistics) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueStatistics) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueStatistics
