...
// APIResultListAttribute Api result list attribute
// swagger:model ApiResult«List«Attribute»»
...
func (m *APIResultListAttribute) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListAttribute) UnmarshalBinary(b []byte) error {
	var res APIResultListAttribute
