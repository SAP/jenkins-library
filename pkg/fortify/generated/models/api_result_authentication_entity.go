...
// APIResultAuthenticationEntity Api result authentication entity
// swagger:model ApiResult«Authentication Entity»
...
func (m *APIResultAuthenticationEntity) validateData(formats strfmt.Registry) error {
...
func (m *APIResultAuthenticationEntity) UnmarshalBinary(b []byte) error {
	var res APIResultAuthenticationEntity
