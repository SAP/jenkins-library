...
// APIResultArtifact Api result artifact
// swagger:model ApiResult«Artifact»
...
func (m *APIResultArtifact) validateData(formats strfmt.Registry) error {
