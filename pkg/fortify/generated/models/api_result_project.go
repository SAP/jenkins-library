...
// APIResultProject Api result project
// swagger:model ApiResult«Project»
...
func (m *APIResultProject) validateData(formats strfmt.Registry) error {
