...
// APIResultListProject Api result list project
// swagger:model ApiResult«List«Project»»
...
func (m *APIResultListProject) validateData(formats strfmt.Registry) error {
