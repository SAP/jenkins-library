...
static getMtaJar(script, stepName, configuration, environment) {
...
static getNeoExecutable(script, stepName, configuration, environment) {
...
static getCmCliExecutable(script, stepName, configuration, environment) {
