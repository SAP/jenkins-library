...
func TestBuildProject(t *testing.T) {
	...
	var flags []string
	flags = append(flags, "-m", "build", "./integration/testdata/TestPythonIntegration")
...
func TestBuildProjectWithoutSource(t *testing.T) {
	t.Parallel()
	container := givenThisContainer(t, IntegrationTestDockerExecRunnerBundle{
		Image: "python:3.9",
	})
	...
	container.assertHasOutput(t, "link to python project dir is not defined in input parameters")
}
