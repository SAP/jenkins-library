...
func addNpmExecuteScriptsFlags(cmd *cobra.Command, stepConfig *npmExecuteScriptsOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.PnpmVersion, "pnpmVersion", os.Getenv("PIPER_pnpmVersion"), "optional parameter to specify the pnpm version to be installed. By default installs latest pnpm version .Only needed when using pnpm package manager.")
