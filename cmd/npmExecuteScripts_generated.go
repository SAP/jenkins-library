...
### pnpm multi-module support: pnpm multi-module projects are supported when each package has its own ` + "`" + `pnpm-lock.yaml` + "`" + ` file. Workspace-based pnpm projects are not supported.
