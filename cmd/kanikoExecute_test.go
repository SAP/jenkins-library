...
func TestRunKanikoExecute(t *testing.T) {
	...
	t.Run("success case - multi context build with CreateBOM", func(t *testing.T) {
		...
		cwd, _ := fileUtils.Getwd()
		expectedParams := [][]string{
			{"--dockerfile", "Dockerfile", "--context", cwd, "--context-sub-path", "/test1", "--destination", "my.registry.com:50000/myImageOne:myTag"},
			{"--dockerfile", "Dockerfile", "--context", cwd, "--context-sub-path", "/test2", "--destination", "my.registry.com:50000/myImageTwo:myTagTwo"},
