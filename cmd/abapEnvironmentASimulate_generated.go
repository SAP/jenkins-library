...
// AbapEnvironmentASimulateCommand Simulation
...
func addAbapEnvironmentASimulateFlags(cmd *cobra.Command, stepConfig *abapEnvironmentASimulateOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.SWCRelease, "SWCRelease", os.Getenv("PIPER_SWCRelease"), "SWCRelease")
	cmd.Flags().StringVar(&stepConfig.SpsLevel, "SpsLevel", os.Getenv("PIPER_SpsLevel"), "SpsLevel")
