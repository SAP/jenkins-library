...
func addMtaBuildFlags(cmd *cobra.Command, stepConfig *mtaBuildOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.Jobs, "jobs", os.Getenv("PIPER_jobs"), "Configures the number of Make jobs that can run simultaneously")
