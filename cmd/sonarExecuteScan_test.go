...
func TestRunSonar(t *testing.T) {
	...
	t.Run("default", func(t *testing.T) {
		...
		assert.Contains(t, sonar.environment, "SONAR_SCANNER_OPTS=-Djavax.net.ssl.trustStorePassword=changeit -Djavax.net.ssl.trustStore="+filepath.Join(getWorkingDir(), ".certificates", "cacerts"))
...
func TestSonarLoadCertificates(t *testing.T) {
	...
	t.Run("use local trust store with downloaded certificates - deactivated", func(t *testing.T) {
		...
		// assert
		assert.NoError(t, err)
		assert.NotContains(t, sonar.environment, "SONAR_SCANNER_OPTS=-Djavax.net.ssl.trustStorePassword=changeit -Djavax.net.ssl.trustStore="+filepath.Join(getWorkingDir(), ".certificates", "cacerts"))
	})
