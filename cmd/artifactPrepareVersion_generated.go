...
func addArtifactPrepareVersionFlags(cmd *cobra.Command, stepConfig *artifactPrepareVersionOptions) {
	...
	cmd.Flags().StringSliceVar(&stepConfig.ExcludeFiles, "excludeFiles", []string{}, "List of files to exclude when committing all changes into created tag. (Useful when using versioningType: cloud with npm or maven.)")
