...
func GetAllStepMetadata() map[string]config.StepData {
	return map[string]config.StepData{
		...
		"getPackageList":                            getPackageListMetadata(),
		...
		"integrationPackageDownload":                integrationPackageDownloadMetadata(),
		"integrationPackageUpload":                  integrationPackageUploadMetadata(),
		...
		"messageMappingDeploy":                      messageMappingDeployMetadata(),
		"messageMappingDownload":                    messageMappingDownloadMetadata(),
		"messageMappingUpload":                      messageMappingUploadMetadata(),
		...
		"scriptCollectionDeploy":                    scriptCollectionDeployMetadata(),
		"scriptCollectionDownload":                  scriptCollectionDownloadMetadata(),
		"scriptCollectionUpload":                    scriptCollectionUploadMetadata(),
		...
		"valueMappingDeploy":                        valueMappingDeployMetadata(),
