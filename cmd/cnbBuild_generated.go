...
func CnbBuildCommand() *cobra.Command {
	...
	var createCnbBuildCmd = &cobra.Command{
		...
		Long: `Executes a Cloud Native Buildpacks build for creating Docker container/s.
Please note, that the cnbBuild step gernerally works despite being in beta state, but there might be changes before we remove the beta notice.`,
