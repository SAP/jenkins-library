...
func TestRunKarma(t *testing.T) {
	t.Run("success case", func(t *testing.T) {
		opts := karmaExecuteTestsOptions{Modules: "./test", InstallCommand: "npm install test", RunCommand: "npm run test"}
	...
	t.Run("error case install command", func(t *testing.T) {
		...
		opts := karmaExecuteTestsOptions{Modules: "./test", InstallCommand: "fail install test", RunCommand: "npm run test"}
