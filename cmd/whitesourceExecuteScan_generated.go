...
func addWhitesourceExecuteScanFlags(cmd *cobra.Command, stepConfig *whitesourceExecuteScanOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.Include, "include", `**/src/main/**/*.java **/*.py **/*.go **/*.js **/*.ts`, "Space separated list of file path patterns to include in the scan")
	cmd.Flags().StringVar(&stepConfig.Exclude, "exclude", `tests/**/*.py **/src/test/**/*.java`, "Space separated list of file path patterns to exclude in the scan")
