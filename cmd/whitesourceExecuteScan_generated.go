...
func (p *whitesourceExecuteScanReports) persist(stepConfig whitesourceExecuteScanOptions, gcpJsonKeyFilePath string, gcsBucketId string, gcsFolderPath string, gcsSubFolder string) {
	...
	content := []gcs.ReportOutputParam{
		...
		{FilePattern: "whitesource/*risk-report.pdf", ParamRef: "", StepResultType: "whitesource-ip"},
		...
		{FilePattern: "whitesource/*risk-report.pdf", ParamRef: "", StepResultType: "whitesource-security"},
				...
				Resources: []config.StepResources{
					...
					},
					{
						...
						Parameters: []map[string]interface{}{
							...
							{"filePattern": "whitesource/*risk-report.pdf", "type": "whitesource-ip"},
							...
							{"filePattern": "whitesource/*risk-report.pdf", "type": "whitesource-security"},
