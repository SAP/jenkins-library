...
func addWhitesourceExecuteScanFlags(cmd *cobra.Command, stepConfig *whitesourceExecuteScanOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.JreDownloadURL, "jreDownloadUrl", `https://sap.github.io/SapMachine/latest/21/linux-x64/jre/`, "URL used for downloading the Java Runtime Environment (JRE) required to run the WhiteSource Unified Agent.")
