...
func CloudFoundryFaasDeployCommand() *cobra.Command {
	const STEP_NAME = "cloudFoundryFaasDeploy"

	metadata := cloudFoundryFaasDeployMetadata()
	var stepConfig cloudFoundryFaasDeployOptions
	var startTime time.Time

	var createCloudFoundryFaasDeployCmd = &cobra.Command{
		Use:   STEP_NAME,
		Short: "cloudFoundryFaasDeploy",
		Long:  `Deploy Function as a Service to SAP Cloud Platform`,
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			cloudFoundryFaasDeploy(stepConfig, &telemetryData)
			telemetryData.ErrorCode = "0"
			log.Entry().Info("SUCCESS")
		},
	}

	addCloudFoundryFaasDeployFlags(createCloudFoundryFaasDeployCmd, &stepConfig)
	return createCloudFoundryFaasDeployCmd
}

func addCloudFoundryFaasDeployFlags(cmd *cobra.Command, stepConfig *cloudFoundryFaasDeployOptions) {
...
func cloudFoundryFaasDeployMetadata() config.StepData {
