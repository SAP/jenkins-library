...
func addDockerBuildFlags(cmd *cobra.Command, stepConfig *dockerBuildOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.ContainerBuildOptions, "containerBuildOptions", os.Getenv("PIPER_containerBuildOptions"), "Deprecated, please use buildOptions. Defines the build options for the Docker BuildKit build.")
	...
	cmd.Flags().StringVar(&stepConfig.ContainerPreparationCommand, "containerPreparationCommand", os.Getenv("PIPER_containerPreparationCommand"), "Defines the command to prepare the build environment. Empty by default since Docker BuildKit does not require special preparation.")
	...
	cmd.Flags().BoolVar(&stepConfig.ReadImageDigest, "readImageDigest", false, "If set to true, the step will read the image digest from the BuildKit metadata file after the build and persist it to the common pipeline environment.")
	...
	cmd.Flags().StringSliceVar(&stepConfig.RegistryMirrors, "registryMirrors", []string{}, "List of registry mirrors to use instead of default index.docker.io.")
			...
			Inputs: config.StepInputs{
				Parameters: []config.StepParameters{
					...
					},
					{
						...
						Mandatory:   false,
						Aliases:     []config.Alias{},
						Default:     os.Getenv("PIPER_containerPreparationCommand"),
					},
					{
