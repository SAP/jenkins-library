...
func runGenerateEvent(config *generateEventOptions, telemetryData *telemetry.CustomData, utils generateEventUtils) error {
	...
	vaultClient.TestFunction()

	//vaultClient.TestFunction(vaultCreds)
