	...
	var theMetaData = config.StepData{
		...
		Spec: config.StepSpec{
			...
			Containers: []config.Container{
				{Image: "gcr.io/kaniko-project/executor:debug", EnvVars: []config.EnvVar{{Name: "container", Value: "docker"}, {Name: "PATH", Value: "/busybox:/kaniko:$PATH"}}, Options: []config.Option{{Name: "-u", Value: "0"}, {Name: "--entrypoint", Value: ""}}},
			},
