...
func addKanikoExecuteFlags(cmd *cobra.Command, stepConfig *kanikoExecuteOptions) {
	...
	cmd.Flags().StringSliceVar(&stepConfig.CustomTLSCertificateLinks, "customTlsCertificateLinks", []string{`http://aia.pki.co.sap.com/aia/SAPNetCA_G2.crt`, `http://aia.pki.co.sap.com/aia/SAP%20Global%20Root%20CA.crt`}, "List containing download links of custom TLS certificates. This is required to ensure trusted connections to registries with custom certificates.")
