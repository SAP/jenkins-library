...
func addMavenExecuteIntegrationFlags(cmd *cobra.Command, stepConfig *mavenExecuteIntegrationOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.PomPath, "pomPath", `integration-tests/pom.xml`, "Path to the pom.xml of the integration-test Maven module. Defaults to `integration-tests/pom.xml`. Override this if your integration-test module lives under a different directory or file name.\n")
