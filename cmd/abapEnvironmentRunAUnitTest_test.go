...
func TestBuildAUnitTestBody(t *testing.T) {
	...
	t.Run("Test AUnit test run body with example yaml config", func(t *testing.T) {
		...
		expectedobjectSetString := `<osl:objectSet xsi:type=\"testSet\" xmlns:osl=\"http://www.sap.com/api/osl\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><osl:set xsi:type=\"testSet\"><osl:package name=\"TestPackage\" includeSubpackages=\"false\"/><osl:package name=\"TestObject\" type=\"CLAS\"/></osl:set></osl:objectSet>`
