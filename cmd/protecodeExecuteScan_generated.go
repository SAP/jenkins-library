...
func addProtecodeExecuteScanFlags(cmd *cobra.Command, stepConfig *protecodeExecuteScanOptions) {
	...
	cmd.Flags().IntVar(&stepConfig.ReplaceProductID, "replaceProductId", false, "Specify product_id which application binary will be replaced and rescanned and product id remains unchanged. By using this parameter, Protecode avoids creating multiple same products. Note this will affect results and feeds.")
