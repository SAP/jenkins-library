...
func ValueMappingArtifactUploadCommand() *cobra.Command {
	...
	metadata := valueMappingArtifactUploadMetadata()
	var stepConfig valueMappingArtifactUploadOptions
	var startTime time.Time
	var logCollector *log.CollectorHook
	var splunkClient *splunk.Splunk
	telemetryClient := &telemetry.Telemetry{}

	var createValueMappingArtifactUploadCmd = &cobra.Command{
		Use:   STEP_NAME,
		Short: "Upload or Update an value mapping designtime artifact",
		Long:  `With this step you can either upload or update a value mapping designtime artifact using the OData API. Learn more about the SAP Cloud Integration remote API for updating an value mapping artifact [here](https://help.sap.com/viewer/368c481cd6954bdfa5d0435479fd4eaf/Cloud/en-US/d1679a80543f46509a7329243b595bdb.html).`,
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			valueMappingArtifactUpload(stepConfig, &stepTelemetryData)
			stepTelemetryData.ErrorCode = "0"
			log.Entry().Info("SUCCESS")
		},
	}

	addValueMappingArtifactUploadFlags(createValueMappingArtifactUploadCmd, &stepConfig)
	return createValueMappingArtifactUploadCmd
}
...
func addValueMappingArtifactUploadFlags(cmd *cobra.Command, stepConfig *valueMappingArtifactUploadOptions) {
	...
	cmd.MarkFlagRequired("valueMappingName")
	cmd.MarkFlagRequired("filePath")
}

// retrieve step metadata
func valueMappingArtifactUploadMetadata() config.StepData {
	var theMetaData = config.StepData{
		Metadata: config.StepMetadata{
			Name:        "valueMappingArtifactUpload",
			Aliases:     []config.Alias{},
			Description: "Upload or Update an value mapping designtime artifact",
		},
			...
			Inputs: config.StepInputs{
				...
				Parameters: []config.StepParameters{
					...
					},
					{
						...
						Mandatory:   true,
						Aliases:     []config.Alias{},
						Default:     os.Getenv("PIPER_valueMappingName"),
					},
					{
						Name:        "packageId",
						ResourceRef: []config.ResourceReference{},
