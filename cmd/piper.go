...
func addRootFlags(rootCmd *cobra.Command) {
	...
	rootCmd.PersistentFlags().StringVar(&GeneralConfig.URLReportFileName, "urlReportFileName", "url_report.txt", "Creates URL report based on step's log. Report will be saved into url_report.txt file")
