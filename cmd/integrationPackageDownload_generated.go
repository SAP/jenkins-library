...
func IntegrationPackageDownloadCommand() *cobra.Command {
	const STEP_NAME = "integrationPackageDownload"

	metadata := integrationPackageDownloadMetadata()
	var stepConfig integrationPackageDownloadOptions
	...
	var createIntegrationPackageDownloadCmd = &cobra.Command{
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			integrationPackageDownload(stepConfig, &stepTelemetryData)
			stepTelemetryData.ErrorCode = "0"
			log.Entry().Info("SUCCESS")
		},
	}

	addIntegrationPackageDownloadFlags(createIntegrationPackageDownloadCmd, &stepConfig)
	return createIntegrationPackageDownloadCmd
}
...
func integrationPackageDownloadMetadata() config.StepData {
