...
func addSonarExecuteScanFlags(cmd *cobra.Command, stepConfig *sonarExecuteScanOptions) {
	...
	cmd.Flags().BoolVar(&stepConfig.WaitForQualityGate, "waitForQualityGate", true, "Whether the scan should wait for and consider the result of the quality gate. if the quality gate fails, then the step and the pipeline will fail")
