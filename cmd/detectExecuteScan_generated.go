...
type detectExecuteScanOptions struct {
	...
	Scanners                   []string `json:"scanners,omitempty" validate:"oneof-custom=signature source"`
	...
	FailOn                     []string `json:"failOn,omitempty" validate:"oneof-custom=ALL BLOCKER CRITICAL MAJOR MINOR NONE"`
