			...
			Inputs: config.StepInputs{
				...
				Parameters: []config.StepParameters{
					...
					},
					{
						...
						Type:        "[]string",
						Mandatory:   false,
						Default:     []string{`--blackduck.signature.scanner.memory=4096`, `--blackduck.timeout=6000`, `--blackduck.trust.cert=true`, `--detect.report.timeout=4800`, `--logging.level.com.synopsys.integration=DEBUG`, `--detect.maven.excluded.scopes=test`},
