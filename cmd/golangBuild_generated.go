...
func addGolangBuildFlags(cmd *cobra.Command, stepConfig *golangBuildOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.GoProxy, "goProxy", os.Getenv("PIPER_goProxy"), "Configures the value of the GOPROXY environment variable, specifying the Go module proxy to use for dependency resolution. Set to the SAP Artifactory proxy to avoid direct access to public registries.")
