...
func addCheckmarxOneExecuteScanFlags(cmd *cobra.Command, stepConfig *checkmarxOneExecuteScanOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.ApplicationID, "applicationId", os.Getenv("PIPER_applicationId"), "The ID of the Checkmarx One application to which the newly created projects will be assigned")
	cmd.Flags().StringVar(&stepConfig.ProjectID, "projectId", os.Getenv("PIPER_projectId"), "The ID of the checkmarxOne project to scan into")
