...
class NpmExecuteTest extends BasePiperTest {
    ...
    @Test
    void testNpmExecute() {
        stepRule.step.npmExecute(script: nullScript, dockerImage: 'node:10-stretch')
        assertEquals 'node:10-stretch', dockerExecuteRule.dockerParams.dockerImage
    }
    ...
    void testNpmExecuteWithClosure() {
        stepRule.step.npmExecute(script: nullScript, dockerImage: 'node:10-stretch', npmCommand: 'run build') { }
