...
class NpmExecuteTest extends BasePiperTest {
    ...
    @Test
    void testNpmExecute() {
        stepRule.step.npmExecute(script: nullScript, dockerImage: 'node:lts-bullseye')
        assertEquals 'node:lts-bullseye', dockerExecuteRule.dockerParams.dockerImage
    }
    ...
    void testNpmExecuteWithClosure() {
        stepRule.step.npmExecute(script: nullScript, dockerImage: 'node:lts-bullseye', npmCommand: 'run build') { }
