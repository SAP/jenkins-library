...
public class YamlSubstituteVariablesTest extends BasePiperTest {
    ...
    public void substituteVariables_SkipsExecution_If_ManifestNotPresent() throws Exception {
        ...
        loggingRule.expect("[YamlSubstituteVariables] Could not find YAML file at ${manifestFileName}. Skipping variable substitution.")

        // execute step
        script.step.yamlSubstituteVariables manifestFile: manifestFileName, variablesFile: variablesFileName, script: nullScript, skipDeletion: true
    ...
    public void substituteVariables_SkipsExecution_If_VariablesFileNotPresent() throws Exception {
        ...
        // check that a proper log is written.
        loggingRule.expect("[YamlSubstituteVariables] Could not find variable substitution file at ${variablesFileName}. Skipping variable substitution.")
    ...
    public void substituteVariables_Throws_If_manifestInvalid() throws Exception {
        ...
        expectedExceptionRule.expectMessage("[YamlSubstituteVariables] Could not load manifest file at ${manifestFileName}.")
    ...
    public void substituteVariables_Throws_If_manifestVariablesInvalid() throws Exception {
        ...
        //check that exception is thrown and that it has the correct message.
        expectedExceptionRule.expect(hudson.AbortException)
        expectedExceptionRule.expectMessage("[YamlSubstituteVariables] Could not load manifest variables file at ${variablesFileName}.")
    ...
    public void substituteVariables_UsesDefaultFileName_If_NoManifestSpecified() throws Exception {
        ...
        // execute step
        script.step.yamlSubstituteVariables script: nullScript, skipDeletion: true
    ...
    public void substituteVariables_UsesDefaultFileName_If_NoVariablesFileSpecified() throws Exception {
        ...
        // execute step
        script.step.yamlSubstituteVariables manifestFile: manifestFileName, script: nullScript, skipDeletion: true
    ...
    public void substituteVariables_ReplacesVariablesProperly_InSingleYamlFiles() throws Exception {
        ...
        // check that a proper log is written.
        loggingRule.expect("[YamlSubstituteVariables] Loaded manifest at ${manifestFileName}!")
                   .expect("[YamlSubstituteVariables] Loaded variables file at ${variablesFileName}!")
                   .expect("[YamlSubstituteVariables] Replaced variables in ${manifestFileName} with variables from ${variablesFileName}.")
                   .expect("[YamlSubstituteVariables] Wrote output file (with variables replaced) at ${manifestFileName}.")

        // execute step
        script.step.yamlSubstituteVariables manifestFile: manifestFileName, variablesFile: variablesFileName, script: nullScript, skipDeletion: true


        String yamlStringAfterReplacement = writeYamlRule.files[writeYamlRule.YAML_DUMP] as String
        Map<String, Object> manifestDataAfterReplacement = writeYamlRule.files[manifestFileName]
    ...
    public void substituteVariables_ReplacesVariablesProperly_InMultiYamlFiles() throws Exception {
        ...
        String yamlStringAfterReplacement = writeYamlRule.files[writeYamlRule.YAML_DUMP] as String
        List<Object> manifestDataAfterReplacement = writeYamlRule.files[manifestFileName]
    ...
    public void substituteVariables_SkipsExecution_If_NoVariablesInManifest() throws Exception {
        ...
        loggingRule.expect("[YamlSubstituteVariables] Loaded manifest at ${manifestFileName}!")
                   .expect("[YamlSubstituteVariables] Loaded variables file at ${variablesFileName}!")
                   .expect("[YamlSubstituteVariables] No variables were found or could be replaced in ${manifestFileName}. Skipping variable substitution.")
