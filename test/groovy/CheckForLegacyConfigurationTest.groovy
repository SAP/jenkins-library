...
class CheckForLegacyConfigurationTest extends BasePiperTest {
    ...
    void testCheckForRemovedConfigKeys() {
        ...
        List errors = checkForLegacyConfiguration.checkForRemovedOrReplacedConfigKeys(nullScript, configChanges)
    ...
    void testCheckForReplacedStep() {
        ...
        List errors = checkForLegacyConfiguration.checkForRemovedOrReplacedSteps(nullScript, configChanges)
    ...
    void testCheckForReplacedStage() {
        ...
        List errors = checkForLegacyConfiguration.checkForRemovedOrReplacedStages(nullScript, configChanges)
    ...
    void testCheckForRenamedNpmScripts() {
        ...
        List errors = checkForLegacyConfiguration.checkForRenamedNpmScripts(nullScript, configChanges)
