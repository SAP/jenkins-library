...
class PiperGoUtilsTest extends BasePiperTest {
    ...
    void testUnstashPiperBinMaster() {
        ...
        shellCallRule.setReturnValue('curl --insecure --retry 5 --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/SAP/jenkins-library/releases/latest/download/piper_master\'', '200')

        piperGoUtils.unstashPiperBin()
        assertThat(shellCallRule.shell.size(), is(4))
        assertThat(shellCallRule.shell[1].toString(), is('curl --insecure --retry 5 --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/SAP/jenkins-library/releases/latest/download/piper_master\''))
    ...
    void testUnstashPiperBinNonMaster() {
        ...
        shellCallRule.setReturnValue('[ -x ./piper ]', 1)
        shellCallRule.setReturnValue('curl --insecure --retry 5 --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/SAP/jenkins-library/releases/download/testTag/piper\'', '200')

        piperGoUtils.unstashPiperBin()
        assertThat(shellCallRule.shell.size(), is(4))
        assertThat(shellCallRule.shell[1].toString(), is('curl --insecure --retry 5 --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/SAP/jenkins-library/releases/download/testTag/piper\''))
        assertThat(shellCallRule.shell[2].toString(), is('chmod +x piper'))
        assertThat(shellCallRule.shell[3].toString(), is('./piper version'))
    }
    ...
    void testUnstashPiperBinFallback() {
        ...
        assertThat(shellCallRule.shell[1].toString(), is('curl --insecure --retry 5 --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/SAP/jenkins-library/releases/download/notAvailable/piper\''))
        assertThat(shellCallRule.shell[2].toString(), is('curl --insecure --retry 5 --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/SAP/jenkins-library/releases/latest/download/piper_master\''))
