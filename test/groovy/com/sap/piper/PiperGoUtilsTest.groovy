...
class PiperGoUtilsTest extends BasePiperTest {
    ...
    void testUnstashPiperBinMaster() {
        ...
        shellCallRule.setReturnValue('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/costae/jenkins-library/releases/download/test2/piper\'', '200')

        piperGoUtils.unstashPiperBin()
        assertThat(shellCallRule.shell.size(), is(4))
        assertThat(shellCallRule.shell[1].toString(), is('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/costae/jenkins-library/releases/download/test2/piper\''))
    ...
    void testUnstashPiperBinFallback() {
        ...
        assertThat(shellCallRule.shell[2].toString(), is('curl --insecure --silent --location --write-out \'%{http_code}\' --output piper \'https://github.com/costae/jenkins-library/releases/download/test2/piper\''))
